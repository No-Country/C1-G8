        ...
        <div class="carousel-item cryptoimage">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h2 className="text-white">
              Access on the value of one crypto in particular
            </h2>
            <h5 className="text-white">
              You can view the cotization of the crypto coins at the moment
            </h5>
          </div>
        </div>
        <div class="carousel-item cryptoimage">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h4 className="text-white">
              Coming soon more functions for the crypto wallet
            </h4>
            <h5 className="text-white">
              You can buy and sell your crypto coins trough the wallet
            </h5>
          </div>
        </div>
      </div>
