...
import megas from "../image/megas.jpg";
    ...
    <div className="container">
      <div className="  d-flex justify-content-center flex-column p-3 ">
        <div className="text-center">
          ...
          <h2>About project</h2>
          <p>
            This project is a web application that allows users to search for
            cryptocurrency prices and compare them to other currencies.
          </p>
        </div>
        <div className="text-center">
          <h3>No Country</h3>
